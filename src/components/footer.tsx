                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="flex space-x-3">
                          ...
                          <Link href="#" aria-label="Tiktok" target="_blank" rel="noopener"><div className="w-8 h-8 rounded-md bg-[#010101] flex items-center justify-center"><SocialIcons.Tiktok className="text-white h-5 w-5"/></div></Link>
                        </div>
                    </div>
