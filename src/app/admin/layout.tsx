...
import { Home, Newspaper, BarChart2, Video, Camera, User, LogOut } from 'lucide-react';
import {
  SidebarProvider,
  Sidebar,
  SidebarHeader,
                  ...
                  <SidebarMenuButton asChild isActive={pathname === '/admin/profile'} tooltip={{children: "Profile"}}>
                    <Link href="/admin/profile">
                      <Avatar className="size-6">
                          <AvatarImage src={user?.photoURL || "https://placehold.co/100x100.png"} alt={user?.displayName || "Om Thakur"} data-ai-hint="person avatar" />
